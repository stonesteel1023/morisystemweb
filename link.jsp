...
<li id="current"><a href="link.jsp">リンク<br /><span>LINK</span></a></li>
...
<tr>
<th><a href="javascript:windowOpen()"><img src="images/link-moriplanning.jpg"/></a></th>
<td><span style="line-height: 80px">・本社ホームページへのリンク</span></td>
</tr>
</table>
...
function windowOpen(){
	window.open('http://www.moriplanning.jp/','window');
}
</script>
</body>
</html>
